                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('attribution_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.attributions.index') }}">
                                    ...
                                    @can('inventaire_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.inventaires.index') }}">
                                    ...
                                    @can('infrastructure_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.infrastructures.index') }}">
                                    ...
                                    @can('chef_projet_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.chef-projets.index') }}">
                                    ...
                                    @can('maintenance_request_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.maintenance-requests.index') }}">
