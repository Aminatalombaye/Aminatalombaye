    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.maintenance-requests.update", [$maintenanceRequest->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="description">{{ trans('cruds.maintenanceRequest.fields.description') }}</label>
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $maintenanceRequest->description) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $maintenanceRequest->status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="created_by" id="created_by" value="{{ old('created_by', $maintenanceRequest->created_by) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="requests[]" id="requests" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="createds[]" id="createds" multiple>
