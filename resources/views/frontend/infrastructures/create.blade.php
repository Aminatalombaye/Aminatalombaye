    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.infrastructures.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="construction_date" id="construction_date" value="{{ old('construction_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="depreciation_plan" id="depreciation_plan" value="{{ old('depreciation_plan', '') }}">
