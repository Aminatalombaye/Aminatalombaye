                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reports.update", [$report->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="report_date" id="report_date" value="{{ old('report_date', $report->report_date) }}" required>
                        ...
                        <div class="form-group">
                            <label for="projects">{{ trans('cruds.report.fields.project') }}</label>
