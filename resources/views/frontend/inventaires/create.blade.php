    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.inventaires.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="in" id="in" value="{{ old('in', '') }}">
                            @if($errors->has('in'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('in') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="out" id="out" value="{{ old('out', '') }}">
                            @if($errors->has('out'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('out') }}
                                </div>
