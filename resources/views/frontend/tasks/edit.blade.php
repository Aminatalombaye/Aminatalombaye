                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="equipements[]" id="equipements" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="scheduled_date" id="scheduled_date" value="{{ old('scheduled_date', $task->scheduled_date) }}" required>
