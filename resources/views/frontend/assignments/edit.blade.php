                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assignments.update", [$assignment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type_attribution" id="type_attribution" value="{{ old('type_attribution', $assignment->type_attribution) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="asset" id="asset" value="{{ old('asset', $assignment->asset) }}">
                            @if($errors->has('asset'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('asset') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="quantity" id="quantity" value="{{ old('quantity', $assignment->quantity) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $assignment->user) }}">
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('user') }}
                                </div>
