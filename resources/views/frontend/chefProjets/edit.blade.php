    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.chef-projets.update", [$chefProjet->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="nom">{{ trans('cruds.chefProjet.fields.nom') }}</label>
                            <input class="form-control" type="text" name="nom" id="nom" value="{{ old('nom', $chefProjet->nom) }}">
                            @if($errors->has('nom'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="prenom" id="prenom" value="{{ old('prenom', $chefProjet->prenom) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="adresse" id="adresse" value="{{ old('adresse', $chefProjet->adresse) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="e_mail" id="e_mail" value="{{ old('e_mail', $chefProjet->e_mail) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telephone" id="telephone" value="{{ old('telephone', $chefProjet->telephone) }}">
