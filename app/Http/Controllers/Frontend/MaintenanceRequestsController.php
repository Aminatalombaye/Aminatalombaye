...
class MaintenanceRequestsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.maintenanceRequests.index', compact('maintenanceRequests'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.maintenanceRequests.create', compact('createds', 'requests'));
    }
    ...
    public function store(StoreMaintenanceRequestRequest $request)
    {
        ...
        return redirect()->route('frontend.maintenance-requests.index');
    }
    ...
    public function edit(MaintenanceRequest $maintenanceRequest)
    {
        ...
        return view('frontend.maintenanceRequests.edit', compact('createds', 'maintenanceRequest', 'requests'));
    }
    ...
    public function show(MaintenanceRequest $maintenanceRequest)
    {
        ...
        return view('frontend.maintenanceRequests.show', compact('maintenanceRequest'));
    }
