...
class TaskController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.tasks.create', compact('assigned_tos', 'equipements', 'statuses', 'tags'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        return view('frontend.tasks.edit', compact('assigned_tos', 'equipements', 'statuses', 'tags', 'task'));
    }
