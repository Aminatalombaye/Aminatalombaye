...
class ChefProjetController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.chefProjets.index', compact('chefProjets'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.chefProjets.create', compact('projets'));
    }
    ...
    public function store(StoreChefProjetRequest $request)
    {
        ...
        return redirect()->route('frontend.chef-projets.index');
    }
    ...
    public function edit(ChefProjet $chefProjet)
    {
        ...
        return view('frontend.chefProjets.edit', compact('chefProjet', 'projets'));
    }
    ...
    public function show(ChefProjet $chefProjet)
    {
        ...
        return view('frontend.chefProjets.show', compact('chefProjet'));
    }
